...
// ═══════════════════════════════════════════════════════════
//  ✏️  CUSTOMIZE — change these two lines only
// ═══════════════════════════════════════════════════════════
const String _kAppName = 'Porter';
const String _kTagline = 'Deliver anything, anywhere';
// ═══════════════════════════════════════════════════════════
...
class _SplashScreenState extends State<SplashScreen>
  ...
  // ── Design tokens — matches home/profile screens ──────────
  ...
  Widget _buildLogoBox() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        // Subtle lift shadow — consistent with card style in home screen
        boxShadow: [
          BoxShadow(
  ...
  Widget _buildLoader() {
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        // Sweep: fill from 0 → 60% → exit right
